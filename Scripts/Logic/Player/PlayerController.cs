...
public class PlayerController : MonoBehaviour
{
	...
	private void Start()
	{
		...
		MessageMgr.Single.AddListener(KeyCode.W, InputState.PRESS, ReveiveW);
		MessageMgr.Single.AddListener(KeyCode.A, InputState.PRESS, ReveiveA);
		MessageMgr.Single.AddListener(KeyCode.S, InputState.PRESS, ReveiveS);
		MessageMgr.Single.AddListener(KeyCode.D, InputState.PRESS, ReveiveD);
		InitData();
	}
	...
	private void OnDestroy()
	{
		...
		MessageMgr.Single.RemoveListener(KeyCode.W, InputState.PRESS, ReveiveW);
		MessageMgr.Single.RemoveListener(KeyCode.A, InputState.PRESS, ReveiveA);
		MessageMgr.Single.RemoveListener(KeyCode.S, InputState.PRESS, ReveiveS);
		MessageMgr.Single.RemoveListener(KeyCode.D, InputState.PRESS, ReveiveD);
	}
